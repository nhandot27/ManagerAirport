...
namespace ManagerAirport.DTOs
{
    public class ScheduleManagersDTO
    {
        ...
        public ScheduleManagersDTO(DateTime date, DateTime time, string from, string to, string flightNumber, string aircraftID, string aircraftName, float economyPrice, float businessPrice, float firstClassPrice, int confirmed, string routesID, string schedulesID)
        {
            this.date = date;
            this.time = time;
            this.from = from;
